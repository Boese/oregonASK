...
CREATE TABLE IF NOT EXISTS `OREGONASKDB`.`NUTRITION` (
  ...
  `SITE_NUMBER` VARCHAR(45) NULL DEFAULT NULL,
  `CNP_WEB_SCHOOL_NUMBER` VARCHAR(45) NULL DEFAULT NULL,
